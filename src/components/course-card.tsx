...
export function CourseCard({ course, progress }: { course: Course, progress?: boolean }) {
    return (
        <Card className="text-dark-ebony md:w-1/4">
            ...
            <CardFooter className="flex flex-row justify-between items-center">
                <Link href={`/ide/${course._id}`} className="rounded-full p-1 bg-gray-100 ml-auto cursor-pointer">
